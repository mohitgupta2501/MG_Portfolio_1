...
const momentsImages = [
    {
        ...
        tag: 'ATHLETIC DOMINANCE',
        title: 'Shot Put & Discus — Multi-Gold Medal Winning Performance',
        color: '#f59e0b',
        rgb: '245,158,11',
        orientation: 'landscape',
        type: 'photo',
    },
    {
        ...
        tag: 'COGNITIVE EXCELLENCE',
        title: 'National Abacus Champion — Mastery in Vedic Mathematics',
        color: '#ff4d5a',
        rgb: '255,77,90',
        orientation: 'landscape',
        type: 'photo',
    },
    {
        ...
        tag: 'TEAM LEADERSHIP',
        title: 'Cricket Leadership — Leading INSIGHT Tournament Success',
        color: '#22c55e',
        rgb: '34,197,94',
        orientation: 'landscape',
        type: 'photo',
    ...
    },
    {
        ...
        title: 'Conducting Technical Sessions — Empowering Future Engineers',
        color: '#3b82f6',
        rgb: '59,130,246',
        orientation: 'portrait',
        type: 'photo',
    },
    {
        ...
        tag: 'KNOWLEDGE DELIVERY',
        title: 'Mentoring Juniors through Departmental Initiatives',
        color: '#3b82f6',
        rgb: '59,130,246',
        orientation: 'portrait',
        type: 'photo',
    ...
    },
    {
        ...
        tag: 'TEAM EXECUTION',
        title: 'Driving Large-Scale Event Success through Coordination & Vision',
        color: '#14b8a6',
        rgb: '20,184,166',
        orientation: 'portrait',
        type: 'photo',
